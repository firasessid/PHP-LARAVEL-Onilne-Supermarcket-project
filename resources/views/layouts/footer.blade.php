...
<section class="newsletter mb-15">
                    ...
                    <div class="col">
                        <div class="widget-about font-md mb-md-3 mb-lg-3 mb-xl-0">
                            <div class="logo mb-30">
                                <a href="index.html" class="mb-15"><img src="{{ asset('assets/imgs/theme/logosuper.png') }}" alt="logo" /></a>
    ...
    <script src="{{url('assets/js/plugins/wow.j')}}s"></script>
    ...
    <script src="{{url('/assets/js/plugins/main.js?v=5.6')}}"></script>
