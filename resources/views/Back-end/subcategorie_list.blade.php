    ...
    <div class="content-header">
        ...
        <div>
            ...
            @can('subcategory-create')
                ...
                <a href="{{route('add_subcategorie')}}" class="btn btn-primary btn-sm rounded">Create new</a>
            @endcan
        </div>
    </div>
    <form action="" method="get">
        ...
        <div class="card mb-4">
            <header class="card-header">
                ...
                <form action="{{ route('subcategorie_list') }}" method="GET" class="mt-3">
                    <div class="row gx-3">
                        <!-- Filtre par statut -->
                    ...
                    <table id="category-table" class="table table-hover">
                        <thead>
                            <tr>
                                ...
                                @if (auth()->user()->can('subcategory-delete') || auth()->user()->can('subcategory-edit'))
                                ...
                                <tr>
                                    ...
                                    <td width="40%">
                                        ...
                                        <a href="#" class="itemside">
                                            <div class="left">
                                                <img src="{{ asset('storage/images/' . $sub->image) }}"
                                            ...
                                            <div class="info pl-3">
                                                ...
                                                <small class="text-muted">Sub_category ID: # {{ $sub->id }}</small>
                                            </div>
                                    ...
                                    <td class="text-end">
                                        <form method="POST" action="{{ route('deletesubcateg', $sub->id) }}">
                                            @csrf
                                            <input name="_method" type="hidden" value="DELETE">
                                            <!-- Edit Button -->
                                            @can('subcategory-edit')

                                                <a href="{{ route('edit', $sub->id) }}" class="btn btn-xs btn-primary btn-flat "
        ...
        @if ($subcategories->hasPages())
                <nav aria-label="Page navigation example">
                    <ul class="pagination justify-content-center">
                        ...
                        @else
                            <li class="page-item">
                                <a class="page-link" href="{{ $subcategories->previousPageUrl() }}" rel="prev">
                        ...
                        @if ($start > 1)
                            <li class="page-item">
                                <a class="page-link" href="{{ $subcategories->url(1) }}">{{ sprintf('%02d', 1) }}</a>
                            </li>
                            <li class="page-item disabled">
                        ...
                        @for ($page = $start; $page <= $end; $page++)
                            ...
                            @else
                                <li class="page-item">
                                    <a class="page-link" href="{{ $subcategories->url($page) }}">{{ sprintf('%02d', $page) }}</a>
                                </li>
                            @endif
                        @endfor
                        ...
                        @if ($end < $subcategories->lastPage())
                            ...
                            <li class="page-item">
                                <a class="page-link" href="{{ $subcategories->url($subcategories->lastPage()) }}">
                                    {{ sprintf('%02d', $subcategories->lastPage()) }}
                                </a>
                            </li>
                        @endif
                        ...
                        @if ($subcategories->hasMorePages())
                            <li class="page-item">
                                <a class="page-link" href="{{ $subcategories->nextPageUrl() }}" rel="next">
...
<script>
    ...
    $('.show_confirm').click(function (event) {
        ...
        swal.fire({
            title: 'Are you sure?',
            text: "You won't be able to revert this Sub_category ",
            icon: 'warning',
