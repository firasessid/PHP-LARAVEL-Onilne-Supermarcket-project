                    ...
                    <div class="col-9">
                        <div class="content-header">
                            ...
                            <div>
                                ...
                                <button id="showAlertButton" class="btn btn-md rounded font-sm hover-up show_alert">Edit</button>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-6">
                            ...
                            <div class="card-body">
                                <div class="mb-4">
                                    ...
                                    <div class="input-container">
                                        <input type="text" id="name"  name="name" placeholder="Category Name" value="{{ $product->name }}" class="form-control @error('name') is-invalid @enderror">
                                        @error('name')
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-container">
                                        <textarea name="description" placeholder="Type here" class="form-control @error('description') is-invalid @enderror" rows="4">{{ $product->description }}</textarea>
                                        @error('description')
                                        <i class="fas fa-exclamation-circle"></i>
                                        <div class="error-message">{{ $message }}</div>
                                        @enderror
                                ...
                                <div class="row">
                                    <div class="mb-4">
                                        ...
                                        <div class="input-container">
                                            <input type="text" value="{{ $product->short_description }}" id="short_description" name="short_description" placeholder="Type here" class="form-control @error('short_description') is-invalid @enderror">
                                    ...
                                    <div class="col-lg-4">
                                        <div class="mb-4">
                                            ...
                                            <div class="row gx-2">
                                                <div class="input-container">
                                                    <input value="{{ $product->quantity }}" type="text" id="quantity" name="quantity" placeholder="?" class="form-control @error('quantity') is-invalid @enderror">
                                                    @error('quantity')
                                                    <i class="fas fa-exclamation-circle"></i>
                                                    <div class="error-message">{{ $message }}</div>
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select class="form-select" id="is_featured" value="{{ $product->is_featured }}" name="is_featured">
                                    ...
                                    <div class="col-lg-4">
                                        ...
                                        <select type="text" id="status" value="{{ $product->status }}" name="status" required class="form-select">
                                ...
                                <div class="mb-4">
                                    ...
                                    <div class="input-container">
                                        <input type="text" id="sku" value="{{ $product->sku }}" name="sku" placeholder="sku" class="form-control @error('sku') is-invalid @enderror">
                                        @error('sku')
                                        <i class="fas fa-exclamation-circle"></i>
                                        <div class="error-message">{{ $message }}</div>
                                ...
                                <div class="row">
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            ...
                                            <div class="input-container">
                                                <input type="text" id="sale_price" value="{{ $product->sale_price }}" name="sale_price" placeholder="$US" class="form-control @error('sale_price') is-invalid @enderror">
                                                @error('sale_price')
                                                <i class="fas fa-exclamation-circle"></i>
                                                <div class="error-message">{{ $message }}</div>
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-4">
                                            ...
                                            <div class="input-container">
                                                <input value="{{ $product->regular_price }}" type="text" id="regular_price" name="regular_price" placeholder="$US" class="form-control @error('regular_price') is-invalid @enderror">
                                                @error('regular_price')
                                                <i class="fas fa-exclamation-circle"></i>
                                                <div class="error-message">{{ $message }}</div>
                                ...
                                <div class="card-body" style="margin-left: 20px;">
                                    <div style="display: flex; align-items: center;">
                                        <div class="form-check form-switch col-sm-6 mb-3">
                                            <input class="form-check-input" type="checkbox" id="has_brand" name="has_brand" role="switch" id="flexSwitchCheckDefault" onchange="toggleBrandInput()" style="transform: scale(1.2);" @if($product->brand_id) checked @endif>
        ...
        brandSelect.disabled = true; // Disable the select field
                            ...
                            <div class="card-body">
                                <div class="input-upload">
                                    ...
                                    <img src="{{ asset('storage/images/' . $image->image) }}" alt="Product Image" width="200">
                                     @endforeach
                                    <div class="input-container">
