...
<body class="single-product">
            ...
            <div class="container">
                <div class="breadcrumb">
                    <h>
                        ...
                        <span></span> <a href="shop-grid-right.html">{{$ray->name}}</a> <span></span> <a
                            href="shop-grid-right.html">{{$category->name}}</a>
                        <span></span><a href="shop-grid-right.html">{{$subcategory->name}}</a> <span></span><a
                            href="shop-grid-right.html">{{$product->name}}</a>
                ...
                <div class="col-xl-10 col-lg-12 m-auto">
                    <div class="product-detail accordion-detail">
                        <div class="row mb-50 mt-30">
                                ...
                                <div class="detail-gallery">
                                    ...
                                    <div class="slider-nav-thumbnails">
                                        @foreach ($product->images as $image)
                                            ...
                                            <div><img src="{{ asset('storage/images/' . $image->image) }}"
                            ...
                            <div class="col-md-6 col-sm-12 col-xs-12">
                                <div class="detail-info pr-30 pl-30">
                                    ...
                                    @endif <h2 class="title-detail">{{$product->name}}</h2>
                                    ...
                                    <div class="clearfix product-price-cover">
                                        <div class="product-price primary-color float-left">
                                            @if ($deal)
                                                <span
                                                    class="current-price text-brand">€{{ $product->sale_price - $deal->discount_percentage }}</span>
                                                <span>
                                                    <span class="save-price font-md color3 ml-15">
                                                        {{ number_format(($deal->discount_percentage / $product->sale_price) * 100) }}%
                                                        Off
                                                    </span>
                                                    <span class="old-price font-md ml-15">€{{ $product->sale_price }}</span>
                                                </span>
                                            @else
                                    ...
                                    <ul class="float-start">
                                        <p class="font-lg">
                                            <li class="mb-5">Ray: <a href="#">{{$ray->name}}</a></li>
                                            <li class="mb-5">Category: <a href="#" rel="tag"> {{$category->name}}</a>
                                            </li>
                                            ...
                                            <li class="mb-5"> Brand: <a href="#" rel="tag">
                                            ...
                                            <li class="mb-5"> Sub category: <a href="#" rel="tag">
                                                    {{$subcategory->name}}</a></li>
                                            <li class="mb-5">SKU:<span class="text-brand"> {{$product->sku}}</span></li>

                                            <li>stock: <span class="text-brand">{{$product->quantity}} items left</span>
                                            </li>
                                    </ul>
                                ...
                                <div class="tab-content shop_info_tab entry-main-content">
                                    ...
                                    <div class="tab-pane fade" id="Vendor-info">
                                        <div class="vendor-logo d-flex mb-30">
                                            <img src="{{ asset('assets/imgs/vendor/vendor-18.svg') }}" alt="" />
                                                ...
                                                <div class="col-lg-8">
                                                    ...
                                                    <div class="comment-list">
                                                        ...
                                                        <div
                                                            ...
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="{{ asset('assets/imgs/blog/author-3.png') }}"
                                                                        alt="" />
                                                                    <a href="#"
                                                        ...
                                                        <div class="single-comment justify-content-between d-flex">
                                                            <div class="user justify-content-between d-flex">
                                                                <div class="thumb text-center">
                                                                    <img src="{{ asset('assets/imgs/blog/author-4.png') }}"
                                                                        alt="" />
                                                                    <a href="#"
                        ...
                        <style>
                            .product-cart-wrap {
                                height: 450px;
                                /* Set a consistent height for all product cards */
                                display: flex;
                            ...
                            .product-img-action-wrap {
                                margin-bottom: 0;
                                /* Remove any margin below the image container */
                                padding-bottom: 0;
                                /* Remove any padding below the image container */
                            }

                            .product-content-wrap {
                                margin-top: 0;
                                /* Remove any margin above the description */
                                padding-top: 0;
                                /* Remove any padding above the description */
                                flex-grow: 1;
                                /* Allow the description area to take up remaining space */
                                display: flex;
                                flex-direction: column;
                                justify-content: space-between;
                                /* Ensures spacing is distributed properly */
                            }

                            .product-card-bottom {
                                margin-top: auto;
                                /* Pushes the "Add" button container to the bottom of the card */
                                display: flex;
                                justify-content: space-between;
                                /* Aligns elements like price and button */
                            }
                        </style>
                        <section class="section-padding pb-5">
                            <div class="container">
                                ...
                                <div class="row">
                                    <div class="col-lg-3 d-none d-lg-flex wow animate__animated animate__fadeIn">
                                        <div class="banner-img style-2">
                                            <div class="banner-text">
                                                <h2 class="mb-100">Products may you like </h2>
                                    ...
                                    <div class="col-lg-9 col-md-12 wow animate__animated animate__fadeIn"
                                        data-wow-delay=".4s">
                                            ...
                                            <div class="tab-pane fade show active" id="tab-one-1" role="tabpanel"
                                                ...
                                                <div class="carausel-4-columns-cover arrow-center position-relative">
                                                    ...
                                                    <div class="carausel-4-columns carausel-arrow-center"
                                                        ...
                                                        @forelse ($recommendedProducts as $p)
                                                                ...
                                                                <div class="product-cart-wrap mb-30 product-featured">
                                                                    <div class="product-img-action-wrap">
                                                                        ...
                                                                        <div class="product-action-1">
                                                                            ...
                                                                            <a aria-label="Add To Wishlist"
                                                                                class="action-btn"
                                                                                href="{{ route('add.wishlist', $p->id) }}"><i
                                                                            ...
                                                                            <a aria-label="Quick view" class="action-btn"
                                                                                ...
                                                                                data-bs-target="#quickViewModal_{{ $p->id }}"><i
                                                                                    class="fi-rs-eye"></i></a>
                                                                        </div>
                                                                        @if ($p->quantity == 0)
                                                                            <div
                                                                    ...
                                                                    <div class="product-content-wrap">
                                                                        <div class="product-category">
                                                                            <a
                                                                                href="shop-grid-right.html">{{$p->description}}</a>
                                                                        </div>
                                                                        <h2><a
                                                                                href="{{ route('products_view', ['id' => $p->id]) }}">{{ $p->name }}</a>
                                                                        </h2>
                                                                        ...
                                                                        <div>
                                                                            <span
                                                                                class="font-small text-muted">{{$p->quantity}}<a
                                                                                    href="vendor-details-1.html">Items left
                                                                                </a></span>
                                                                        </div>
                                                                            ...
                                                                            <div class="product-price">
                                                                                @foreach ($activeDeal as $product)
                                                                                    @if ($p->id == $product->product->id)
                                                                                        ...
                                                                                        <span
                                                                                            class="old-price">€{{ $p->sale_price }}</span>
                                                                                    @endif
                                                                                @endforeach
    ...
    <script src="{{ url('assets/js/plugins/jquery.syotimer.min.js') }}"></script>
    <script src="{{ url('assets/js/plugins/wow.js') }}"></script>
    <script src="{{ url('assets/js/plugins/perfect-scrollbar.js') }}"></script>
    ...
    <script src="{{ url('assets/js/plugins/jquery.theia.sticky.js') }}"></script>
    <script src="{{ url('assets/js/plugins/jquery.elevatezoom.js') }}"></script>
    <!-- Template  JS -->
    <script src="{{ url('./assets/js/main.js?v=5.6') }}"></script>
    <script src="{{ url('./assets/js/shop.js?v=5.6') }}"></script>
</body>
